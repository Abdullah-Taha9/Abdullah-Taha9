...
**[forward.md](https://github.com/Abdullah-Taha9/forward.md)** — My setup for AI agent session continuity — a simple markdown convention so any tool can pick up exactly where the last one left off
